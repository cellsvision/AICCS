...
class LogROCCallback(object):
    ...
    def __call__(self, param):
        ...
        for class_name in self.class_names:
            ...
            print(im.shape)
            self.summary_writer.add_image(self.prefix+'_'+class_name, im, dataformats='HWC')
...
class LogDetectionsCallback(object):
    ...
    def __call__(self, param):
        ...
        for i in range(detections.shape[0]):
            ...
            self.summary_writer.add_image('image'+str(i)+'.png', img_det_graph, dataformats='HWC')
        return result
