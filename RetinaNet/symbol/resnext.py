...
def residual_unit(data, num_filter, stride, dim_match, name, bottle_neck=True, num_group=32, bn_mom=0.9, workspace=512, memonger=False):
    ...
    if bottle_neck:
        ...
        conv2 = mx.sym.Convolution(data=act1, num_filter=num_filter, num_group=num_group, kernel=(3,3), stride=(1,1), pad=(1,1),
                                      no_bias=True, workspace=workspace, name=name + '_conv2')
...
def get_resnet_conv(data, num_layers, bottle_neck=True, filter_list=[256, 512, 1024, 2048], num_group=32, **kwargs):
    ...
    # res2
    unit = residual_unit(data=pool0, num_filter=filter_list[0], stride=(1, 1), dim_match=False, name='stage1_unit1', num_group=num_group, bottle_neck=bottle_neck)
    for i in range(2, units[0] + 1):
        unit = residual_unit(data=unit, num_filter=filter_list[0], stride=(1, 1), dim_match=True,
                             name='stage1_unit%s' % i, num_group=num_group, bottle_neck=bottle_neck)
    conv_C2 = unit

    # res3
    unit = residual_unit(data=unit, num_filter=filter_list[1], stride=(2, 2), dim_match=False, name='stage2_unit1', num_group=num_group, bottle_neck=bottle_neck)
    for i in range(2, units[1] + 1):
        unit = residual_unit(data=unit, num_filter=filter_list[1], stride=(1, 1), dim_match=True,
                             name='stage2_unit%s' % i, num_group=num_group, bottle_neck=bottle_neck)
    conv_C3 = unit

    # res4
    unit = residual_unit(data=unit, num_filter=filter_list[2], stride=(2, 2), dim_match=False, name='stage3_unit1', num_group=num_group, bottle_neck=bottle_neck)
    for i in range(2, units[2] + 1):
        unit = residual_unit(data=unit, num_filter=filter_list[2], stride=(1, 1), dim_match=True,
                             name='stage3_unit%s' % i, num_group=num_group, bottle_neck=bottle_neck)
    conv_C4 = unit

    # res5
    unit = residual_unit(data=unit, num_filter=filter_list[3], stride=(2, 2), dim_match=False, name='stage4_unit1', num_group=num_group, bottle_neck=bottle_neck)
    for i in range(2, units[3] + 1):
        unit = residual_unit(data=unit, num_filter=filter_list[3], stride=(1, 1), dim_match=True,
                             name='stage4_unit%s' % i, num_group=num_group, bottle_neck=bottle_neck)
    conv_C5 = unit
...
def resnext(units, num_stages, filter_list, num_classes, num_group, image_shape, bottle_neck=True, bn_mom=0.9, workspace=512, dtype='float32', memonger=False):
