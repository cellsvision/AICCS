...
def parse_args():
    ...
    parser.add_argument('--warmup-epoch', dest='warmup_epoch', type=float, default=1,
                        help='warmup epoch for training, default is 1.')
